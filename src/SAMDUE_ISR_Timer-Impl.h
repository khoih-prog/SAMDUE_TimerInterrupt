...
SAMDUE_ISR_Timer::SAMDUE_ISR_Timer()
  : numTimers (-1)
{
}

void SAMDUE_ISR_Timer::init() 
{
...
int SAMDUE_ISR_Timer::findFirstFreeSlot() 
{
  // all slots are used
...
void SAMDUE_ISR_Timer::enableAll() 
{
...
void SAMDUE_ISR_Timer::disableAll() 
{
...
unsigned SAMDUE_ISR_Timer::getNumTimers() 
{
  return numTimers;
}
